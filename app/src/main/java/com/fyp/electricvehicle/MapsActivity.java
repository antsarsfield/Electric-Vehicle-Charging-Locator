...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView txtselectlocation=findViewById(R.id.txtselectlocation);
        txtselectlocation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String url = "https://www.google.com/maps/dir/?api=1&destination=" + Double.valueOf(thedata.get(position).getLatitude())+ "," + Double.valueOf(thedata.get(position).getLongitude()) + "&travelmode=driving";
